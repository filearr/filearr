module github.com/filearr/filearr/agent

go 1.26

require (
	github.com/fsnotify/fsnotify v1.10.1
	// P5-T3a ruling: EXACT pin, never @latest — the go.sum hash freezes the
	// audited code. Any bump MUST re-pass internal/scan/gitignore_test.go's
	// 44-vector gate (git's own edge cases, incl. Icon[\r] and $RECYCLE.BIN/).
